    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: const [
              Expanded(flex: 1, child: Text("Barcode #", style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.center)),
              Expanded(flex: 1, child: Text("Date", style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.center)),
              Expanded(flex: 1, child: Text("Product", style: TextStyle(fontWeight: FontWeight.bold), textAlign: TextAlign.center)),
          ...
          child: user == null
            ...
            builder: (context, snapshot) {
              ...
              if (filteredProducts.isEmpty && products.isEmpty) {
                return const Center(child: Text('No saved products', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500)));
              }
